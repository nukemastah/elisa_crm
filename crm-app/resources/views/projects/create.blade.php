...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <form method="POST" action="{{ route('projects.store') }}" style="display: flex; flex-direction: column; gap: 1rem;">
        ...
        <div style="display: flex; gap: 1rem; margin-top: 1rem;">
            ...
            <button type="button" onclick="window.location.href='{{ route('projects.index') }}'" style="background: #e74c3c; color: white; padding: 0.75rem 1.5rem; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;">Cancel</button>
        </div>
    </form>
</div>
@endsection
